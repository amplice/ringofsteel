...
export const knight = defineCharacter('knight', {
  ...
  backstepAttackBonusWindowFrames: 16,
  backstepAttackLungeBonus: 0.12,
  backstepAttackFrameMult: 0.98,
  heavyGuardBreakLungeBonus: 0.42,
  heavyGuardBreakAttackFrameMult: 0.56,
