...
export const AI_CLASS_PROFILE_SETS = Object.freeze({
  spearman: ['spearman_evasive', 'spearman_heavy_bully', 'spearman_aggressor'],
  ronin: ['ronin_evasive', 'ronin_lancer', 'ronin_duelist'],
  knight: ['knight_duelist', 'knight_bulwark', 'knight_sentinel'],
});
